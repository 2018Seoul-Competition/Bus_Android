...
public class ArrivalNotificationForeGroundService extends Service implements TextToSpeech.OnInitListener{
    ...
    public void onCreate(){
        ...
        if(BaseApplication.LAN_MODE.compareTo("KR") == 0)
            Toast.makeText(getApplicationContext(), "앱을 동작시키기 위해서는 GPS 기능을 켜야합니다", Toast.LENGTH_SHORT).show();
        else
            Toast.makeText(getApplicationContext(), "You have to turn on GPS for app", Toast.LENGTH_SHORT).show();
